...
<div class="container">
	<div class="mb-4 flex justify-between">
		<div>
			<h1 class="mb-2 text-xl font-semibold text-slate-800">Update {data.metricType.label}</h1>
		</div>
	</div>

	<div class="relative overflow-x-auto rounded-lg border bg-white p-5">
		<form method="post" action="/metrics/{data.metricType.id}?/update">
			...
			<div class="flex items-center space-x-4">
				...
				<button
					formaction="/metrics/{data.metricType.id}?/destroy"
